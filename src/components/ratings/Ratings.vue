<template>
  <div class="ratings" ref="ratings">
    <div class="ratings-content">
      ...
      <split></split>
      <ratingselect ref="rating" :select-type="selectType" @udselect="selectType = $event" :only-content="onlyContent" @tgContent="toggleContent" :ratings="ratings" :desc="desc"></ratingselect>
